...
export const puzzles: PuzzleConfig[] = [
  ...
  },
  {
    ...
    clue: toBase64('Dronningen har en hemmelighet, du n\u00E6rmer deg en avsl\u00F8ring.'),
    icon: '\uD83D\uDCDC',
    theme: 'amber',
  },
  {
    ...
    type: 'walle_sort',
    clue: toBase64('Kanskje alt er en SIMulering? Er dronningen den du tror hun er?'),
    icon: '\uD83E\uDD16',
    theme: 'yellow',
  },
  {
    ...
    clue: toBase64('Landstrykeren har sine meninger om beliggenhet'),
    icon: '\uD83C\uDFB8',
    theme: 'green',
  },
  {
    ...
    type: 'london_maze',
    clue: toBase64('SIMuleringen skal skje p\u00E5 Landstrykerens plass med Dronningen n\u00E6re ved. Inne i Landstrykeren er skapningen'),
    icon: '\uD83C\uDDEC\uD83C\uDDE7',
    theme: 'blue',
  },
];
